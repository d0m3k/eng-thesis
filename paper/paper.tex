...
\acknowledgements{Serdecznie dziękuję promotorowi za możliwość zrealizowania pasjonującego tematu, a rodzinie i przyjaciołom za wiarę w to, że się uda.}
...
\include{chapter1_abstract}
\include{chapter2_distributed}
\include{chapter3_implementation}
\include{chapter4_tests}
