...
% Z tego poniżej może powstać osobny rozdział, gdzie to co powyżej stanowiłoby bardizej rozważania na temat właściwego podejścia do realizacji projektu, a to poniżej -- faktyczny opis implementacji systemu, podzielony bardziej granularnie dla każdego z elemenetów
