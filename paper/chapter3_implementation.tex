...
\begin{enumerate}
    ...
    \item Jeśli otrzymasz informacje o innych węzłach, utwórz połączenie z nimi i wymień się metadanymi. \\ \parbox{\linewidth}{\centering \includegraphics[scale=0.45]{node-with-rs-n-neighbors.pdf}\captionof{figure}{Wizualizacja połączenia z {\em Rendezvous Server}, posiadającego dostęp do innych węzłów sieci.}}
\end{enumerate}
