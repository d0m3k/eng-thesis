...
\begin{lstlisting}[language=javascript]
    filesAvailable: function() -> [RequestURL]
\end{lstlisting}
...
Lista \texttt{RequestURL} obsługiwanych przez dany węzeł.
...
Ta sekcja również zawiera funkcje, spełniają one jednak specyficzną funkcję -- są częścią {\em reaktywną} systemu, wołane są poprzez odwołania w czasie połączeń między węzłami i stanowią definicję reakcji na sytuacje i zapytania występujące w systemie.
